...
- AI-assisted software development and QA.

## Five Project Highlights

- Built a custom listening analytics system around Last.fm scrobble history and Spotify playlist data.
...
This project was developed with significant AI-assisted coding support. My role focused on product direction, analytical logic, feature specification, testing, critique, workflow design, and iterative refinement.
