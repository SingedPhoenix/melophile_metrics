...
- Fresh: seed/harvest gateway restored in React with SQLite-backed path panels, Spotify playlist-family loading, and release discovery shelves. Still recover pruning/decision workflow, harvest rankings, and scheduled scanning.
